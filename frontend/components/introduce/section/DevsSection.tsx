      ...
      <div className="flex flex-col">
        {ITEMS_DEVS.map((item) => (
          <Link
            key={item.title}
            href={item.href}
            className="flex items-center gap-6 border-t border-[#1a1a1a] px-8 py-6 relative overflow-hidden transition-all duration-300 group hover:bg-[#0a0a0a] last:border-b"
          >
