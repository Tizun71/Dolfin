        ...
        {SUPPORT_ITEMS.map((item, index) => {
          ...
          return (
            <Link
              ...
              className={`group relative flex flex-col items-center gap-6 overflow-hidden rounded-xl border border-[#1a1a1a] px-8 py-10 transition-all duration-500 ${
                isVisible
                  ? "opacity-100 translate-y-0"
            ...
            >
              ...
              <div
                className={`relative flex h-20 w-20 flex-shrink-0 items-center justify-center rounded-2xl border border-[#222] bg-[#0d0d0d] transition-all duration-300 group-hover:border-yellow-500/50 group-hover:shadow-[0_0_20px_rgba(251,191,36,0.15)] ${
