...
export default function WeETHDetail() {
    ...
    <div className="min-h-screen bg-black text-white font-sans px-12 py-10">
      ...
      <div className="flex items-center gap-6 mb-10 border-b border-[#1a1a1a] pb-8">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full flex items-center justify-center text-lg border border-[#9B59B644] text-[#9B59B6]">
            ◈
          </div>
          <div>
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div className="border border-[#1a1a1a] bg-[#050505] p-8">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-8">
              <div className="relative w-24 h-24 flex-shrink-0">
                <svg viewBox="0 0 100 100" className="w-full h-full -rotate-90">
                  ...
                  <circle
                    ...
                    stroke="#9B59B6"
                    strokeWidth="8"
                    strokeDasharray={`${(2 * Math.PI * 42 * 89.17) / 100} ${
                      2 * Math.PI * 42
                    }`}
                    opacity="0.8"
                  />
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-sm font-light text-white">89.17%</span>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-xl font-light text-white">1.07M of 1.20M</p>
                <p className="text-[#555] text-sm font-mono mt-1">
                  $2.71B of $3.05B
                </p>
                <p className="text-xs font-mono mt-3 tracking-[2px] text-[#9B59B6]">
                  APY &lt; 0.01%
                </p>
              </div>
            </div>
          ...
          <div className="mb-8">
            ...
            <div className="bg-[#080808] border border-[#111] p-4">
              ...
              >
                <defs>
                  <linearGradient id="weethFill" x1="0" y1="0" x2="0" y2="1">
        ...
        <div className="border border-[#1a1a1a] bg-[#050505] p-8 flex flex-col">
          ...
          <div className="flex items-center justify-between border border-[#9B59B622] bg-[#9B59B608] px-5 py-4 mb-6">
            <div className="flex items-center gap-3">
              <div className="w-7 h-7 rounded-full flex items-center justify-center text-sm border border-[#9B59B644] text-[#9B59B6]">
                ◈
              </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {capabilities.map((cap) => (
                ...
                >
                  <div className="w-1 min-h-[32px] flex-shrink-0 mt-1 bg-[#9B59B6] opacity-60" />
                  <div>
