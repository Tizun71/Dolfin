    ...
    <div className="min-h-screen bg-black text-white font-sans px-12 py-10">
      ...
      <div className="flex items-center gap-6 mb-10 border-b border-[#1a1a1a] pb-8">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full flex items-center justify-center text-lg border border-[#26A17B44] text-[#26A17B]">
            ₮
          </div>
          <div>
      ...
      <div className="grid grid-cols-2 gap-8">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-8">
              <div className="relative w-24 h-24 flex-shrink-0">
                <svg viewBox="0 0 100 100" className="w-full h-full -rotate-90">
                  ...
                  <circle
                    ...
                    stroke="#26A17B"
                    strokeWidth="8"
                    strokeDasharray={`${(2 * Math.PI * 42 * 91.9) / 100} ${2 * Math.PI * 42}`}
                    opacity="0.8"
                  />
                </svg>
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-sm font-light text-white">91.90%</span>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-xl font-light text-white">643.33M of 700M</p>
                <p className="text-[#555] text-sm font-mono mt-1">
                  $643.33M of $700M
                </p>
                <p className="text-xs font-mono mt-3 tracking-[2px] text-[#26A17B]">
                  APY 4.91%
                </p>
              </div>
            </div>
              ...
              >
                <defs>
                  <linearGradient id="usdtFill" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#26A17B" stopOpacity="0.15" />
                    <stop offset="100%" stopColor="#26A17B" stopOpacity="0" />
                  </linearGradient>
                </defs>
                <line
                  x1="0"
          ...
          <div className="border-t border-[#1a1a1a] pt-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                { label: "Liq. Threshold", value: "38%" },
                { label: "Liq. Penalty", value: "3.80%" },
              ].map((item) => (
        ...
        <div className="border border-[#1a1a1a] bg-[#050505] p-8 flex flex-col">
          ...
          <div
            ...
            style={{
              border: "1px solid #26A17B22",
              backgroundColor: "#26A17B08",
            }}
          >
            <div className="flex items-center gap-3">
              <div className="w-7 h-7 rounded-full flex items-center justify-center text-sm border border-[#26A17B44] text-[#26A17B]">
                ₮
              </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {capabilities.map((cap) => (
                ...
                >
                  <div className="w-1 min-h-[32px] flex-shrink-0 mt-1 bg-[#26A17B] opacity-60" />
                  <div>
