    ...
    <div className="min-h-screen bg-black text-white font-sans px-12 py-10">
      ...
      <div className="flex items-center gap-6 mb-10 border-b border-[#1a1a1a] pb-8">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full flex items-center justify-center text-lg border border-[#F7931A44] text-[#F7931A]">
            ₿
          </div>
          <div>
        ...
        <div className="border border-[#1a1a1a] bg-[#050505] p-8">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-8">
              <div className="relative w-24 h-24 flex-shrink-0">
                <svg viewBox="0 0 100 100" className="w-full h-full -rotate-90">
                  ...
                  <circle
                    ...
                    stroke="#F7931A"
                    strokeWidth="8"
                    strokeDasharray={`${(2 * Math.PI * 42 * 85.46) / 100} ${
                      2 * Math.PI * 42
                    }`}
                    opacity="0.8"
                  />
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-sm font-light text-white">85.46%</span>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-xl font-light text-white">29.91K of 35K</p>
                <p className="text-[#555] text-sm font-mono mt-1">
                  $2.42B of $2.83B
                </p>
                <p className="text-xs font-mono mt-3 tracking-[2px] text-[#F7931A]">
                  APY &lt; 0.01%
                </p>
              </div>
            </div>
          ...
          <div className="mb-8">
            ...
            <div className="bg-[#080808] border border-[#111] p-4">
              ...
              >
                <defs>
                  <linearGradient id="wbtcFill" x1="0" y1="0" x2="0" y2="1">
        ...
        <div className="border border-[#1a1a1a] bg-[#050505] p-8 flex flex-col">
          ...
          <div
            ...
            style={{
              ...
              backgroundColor: "#F7931A08",
            }}
          >
            <div className="flex items-center gap-3">
              <div className="w-7 h-7 rounded-full flex items-center justify-center text-sm border border-[#F7931A44] text-[#F7931A]">
                ₿
              </div>
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {capabilities.map((cap) => (
                ...
                >
                  <div className="w-1 min-h-[32px] flex-shrink-0 mt-1 bg-[#F7931A] opacity-60" />
                  <div>
