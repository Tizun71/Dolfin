    ...
    <div className="min-h-screen bg-black text-white font-sans px-12 py-10">
      ...
      <div className="flex items-center gap-6 mb-10 border-b border-[#1a1a1a] pb-8">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full flex items-center justify-center text-xl border border-[#00A3FF44] text-[#00A3FF]">
            ⟠
          </div>
          <div>
        ...
        <div className="border border-[#1a1a1a] bg-[#050505] p-8">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-8">
              <div className="relative w-24 h-24 flex-shrink-0">
                <svg viewBox="0 0 100 100" className="w-full h-full -rotate-90">
                  ...
                  <circle
                    ...
                    stroke="#00A3FF"
                    strokeWidth="8"
                    strokeDasharray={`${(2 * Math.PI * 42 * 86.12) / 100} ${2 * Math.PI * 42}`}
                    opacity="0.8"
                  />
                </svg>
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-sm font-light text-white">86.12%</span>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-xl font-light text-white">473.68K of 550K</p>
                <p className="text-[#555] text-sm font-mono mt-1">
                  $1.27B of $1.47B
                </p>
                <p className="text-xs font-mono mt-3 tracking-[2px] text-[#00A3FF]">
                  APY &lt; 0.01%
                </p>
              </div>
            </div>
          ...
          <div className="mb-8">
            ...
            <div className="bg-[#080808] border border-[#111] p-4">
              ...
              >
                <defs>
                  <linearGradient id="wstethFill" x1="0" y1="0" x2="0" y2="1">
        ...
        <div className="border border-[#1a1a1a] bg-[#050505] p-8 flex flex-col">
          ...
          <div
            ...
            style={{
              ...
              backgroundColor: "#00A3FF08",
            }}
          >
            <div className="flex items-center gap-3">
              <div className="w-7 h-7 rounded-full flex items-center justify-center text-sm border border-[#00A3FF44] text-[#00A3FF]">
                ⟠
              </div>
